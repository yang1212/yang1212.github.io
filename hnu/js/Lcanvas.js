(function ($) {
            ...
            for (var i = 0; i < 5; i++) {
                (function (r) {
                    setTimeout(function () {
                        ...
                        ctx.moveTo(that.p.x *.7, that.p.y);
                        ctx.arc(that.p.x *.7, that.p.y, r, 0, Branch.circle, true);
                        ctx.fill();
                    }, r * 60);
                })(i);
            }
    ...
    Branch.prototype = {
        ...
        draw: function () {
            ...
            ctx.arc(this.p.x *.7, this.p.y, this.r, 0, Branch.circle, true);
            ctx.fill();
        },
        modify: function () {
    ...
    function init() {
        var $window = $(window);
        var $body = $("body");
        var canvas_width = $window.width()*.8;
        var canvas_height = $window.height() - 150;
